...
class ProviderControlService(object):
    ...
    def GetListUnclaimed(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/escrow.ProviderControlService/GetListUnclaimed',
    ...
    def GetListInProgress(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/escrow.ProviderControlService/GetListInProgress',
            control__service__pb2.GetPaymentsListRequest.SerializeToString,
            control__service__pb2.PaymentsListReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def StartClaim(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/escrow.ProviderControlService/StartClaim',
