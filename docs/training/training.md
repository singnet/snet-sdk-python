...
1. [Training](#class-training)
   ...
   - [_call_method](#_call_method)
   - [_get_training_stub](#_get_training_stub)
   - [_get_auth_details](#_get_auth_details)
   - [_check_method_name](#_check_method_name)
   - [_check_training](#_check_training)
   - [_check_dataset](#_check_dataset)
